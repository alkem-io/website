      ...
      text: |-
        ...
        <div id="alkemio-sharing" class="collapse">
          <div class="content">
            ...
            <strong>Special mentions to the following external parties that have helped Alkemio on our journey so far:</strong>
            <ul>
            ...
            <ul>
              <li><a href="./documents/stichting_alkemio_statuten_2021_12.pdf">Stichting Alkemio Articles of Association (AoA)</a> (Dutch).</li>
              <li><a href="./documents/alkemio_holding_statuten.pdf">Alkemio Holding Articles of Association (AoA)</a> (Dutch)</li>
              <li><a href="./documents/alkemio_holding_uitgifte_aandelen_pc_cc.pdf">Alkemio Holding Issuance of share PC + shares CC</a> (Dutch)</li>
              <li><a href="./documents/alkemio_holding_shareholders_agreement_v1.1.pdf">Alkemio Holding Shareholders Agreement (SHA)</a> (English) </li>
              <li><a href="./documents/stak_participanten_alkemio_akte_oprichting.pdf">STAK Participanten Alkemio Articles of Association (AoA)</a> (Dutch)</li>
              <li><a href="./documents/stak_participanten_alkemio_administratievoorwaarden.pdf">STAK Participanten Alkemio Conditions</a> (Dutch)</li>
            </ul>
  ...
  - block: markdown
    content:
      ...
      text: |-
        ...
        Interested in learning how you can do well and do good? Please <a href="/investors">visit our investors</a> page!
    design:
      background:
        image:
          filename:
